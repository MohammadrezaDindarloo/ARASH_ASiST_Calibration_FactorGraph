...
namespace gtsam
{  
    class ArashAsistFactor : public NoiseModelFactor3<double, double, double, double>
    {
        ...
        public:
        // Constructor
        ArashAsistFactor(Key key1, Key key2, Key key3, Key key4, gtsam::Vector3 groud_truth_, double phi_, double psi_, const SharedNoiseModel &model) 
        : NoiseModelFactor3<double, double, double, double>(model, key1, key2, key3, key4), groud_truth(groud_truth_), phi(phi_), psi(psi_) {}

        // Evaluate the error
        Vector evaluateError(const double &alpha, const double &theta, const double &L, const double &d,
                             ...
                             OptionalMatrixType H4) const override
        {
            ...
            {   
                ...
                *H4 = (gtsam::Matrix(3, 1) << derivative_wrt_d[0], derivative_wrt_d[1], derivative_wrt_d[2]).finished();
            }
